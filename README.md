...
- Designed modular Python pipelines improving **retrieval grounding & hallucination reduction**.

### **Research Assistant (Computer Vision) — University at Buffalo**
*Feb 2025 – Oct 2025*  
- Developed real-time **parking availability detection** with **92%+ accuracy**.
...
- Authored **40+ pages** of technical documentation.

### **Full-Stack Development Intern — Qu Anytime**
*Jan 2025 – May 2025*  
- Built React Native mobile features for **500+ concurrent users**.
- Integrated OAuth, AWS-hosted APIs, real-time messaging.
- Reduced deployment time from **1 day → under 2 hours** via CI/CD.

### **Assistant Manager — Jio Platforms Limited**
*Dec 2023 – Jul 2024*  
- Built ML & analytics solutions on **petabyte-scale data**.
- Designed recommender systems increasing engagement by **25%**.
- Delivered **15+ Tableau dashboards** across Databricks & Snowflake.
...
![T5](https://img.shields.io/badge/T5-FF6F00?style=flat-square)
![Vision Transformer](https://img.shields.io/badge/ViT-4B8BBE?style=flat-square)
